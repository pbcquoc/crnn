...
```
To use GPU to speed up your training, just pass ``--cuda`` in options. Your trained model will be exported you `--save_model` in options. Please see the code for more optitions.
